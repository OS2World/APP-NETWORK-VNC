...
typedef struct {
    REQP_HEADER header;
    BYTE	category;	// Function Category
    BYTE	function;	// Function Code 
    PVOID FAR	param;		// Parameter Buffer Address
    PVOID FAR	data;		// Data Buffer Address
    USHORT	fn;		// System File Number
    USHORT	paramlen;	// Length of parameter puffer
    USHORT	datalen;	// Length of data buffer
} REQP_IOCTL;
